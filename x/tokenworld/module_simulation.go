...
import (
	...
	"tokenworld/testutil/sample"
	tokenworldsimulation "tokenworld/x/tokenworld/simulation"
...
var (
	_ = sample.AccAddress
	_ = tokenworldsimulation.FindAccount
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	tokenworldGenesis := types.GenesisState{
		Params: types.DefaultParams(),
		// this line is used by starport scaffolding # simapp/module/genesisState
	}
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&tokenworldGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgMint,
		tokenworldsimulation.SimulateMsgMint(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgBurn,
		tokenworldsimulation.SimulateMsgBurn(am.accountKeeper, am.bankKeeper, am.keeper),
	))
