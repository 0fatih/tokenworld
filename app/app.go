...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		tokenworldmodule.AppModuleBasic{},
...
type App struct {
	*baseapp.BaseApp
	...
	TokenworldKeeper tokenworldmodulekeeper.Keeper
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		tokenworldmoduletypes.StoreKey,
	...
	*/
	...
	app.TokenworldKeeper = *tokenworldmodulekeeper.NewKeeper(
		appCodec,
	...
	app.mm.SetOrderBeginBlockers(
		...
		tokenworldmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(tokenworldmoduletypes.ModuleName)
